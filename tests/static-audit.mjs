...
ok('active save key v0240', script.includes('f1_manager_career_2026_v0240'));
ok('visual 3d system present', fs.existsSync(path.join(root,'data/visual-data.js')) && fs.existsSync(path.join(root,'src/core/track-visual-system.js')) && script.includes('visualSystem'));
ok('audio ui system present', fs.existsSync(path.join(root,'data/audio-ui-data.js')) && fs.existsSync(path.join(root,'src/core/audio-ui-system.js')) && script.includes('audioUI'));
ok('operations system present', fs.existsSync(path.join(root,'data/operations-data.js')) && fs.existsSync(path.join(root,'src/core/operations-system.js')) && script.includes('operationsSystem'));
